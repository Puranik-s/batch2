...
public class OrderServiceImpl implements OrderService{
	...
	public Order updateOrder(Order order) {
		Optional<Order> optionalCustomer = orderRepository.findById(order.getOrderId());
        if(optionalCustomer.isEmpty()) {
        	throw new ResourceNotFoundException("Customer not existing with id: "+order.getOrderId()); 
        }
        return order;
	}
	@Override
	public void deleteOrder( int orderId) {
		Optional<Order> optinalProduct = orderRepository.findById(orderId);
	     if(optinalProduct.isEmpty()) {
	    	 throw new ResourceNotFoundException("Product not existing with id :"+orderId);
			}
